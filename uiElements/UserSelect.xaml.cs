    ...
    public partial class UserSelect : UserControl
    {
        ...
        public SimpleUserEntity User
        {
            ...
            set
            {
                ...
                // Updates the ui
                this.ButtonSelect.Content = value.ToString();
                this.ButtonSelect.Foreground = Brushes.OrangeRed;
            }
        }

        /// <summary>
        /// Unselects the current user from the selection if there was one selected
        /// </summary>
        public void UnselectUser()
        {
            // Unselects the current user
            this.user = null;

            // Updates the ui
            this.ButtonSelect.Foreground = Brushes.Black;
            this.ButtonSelect.Content = Lang.ui_userselect_button;
        }
        ...
        private void OnSelectUser(object server, SelectionChangedEventArgs e)
        {
            ...
            this.User = (SimpleUserEntity)((ListViewItem)this.List.SelectedItem).Content;
        }
